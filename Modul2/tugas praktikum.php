...
<html>
	...
	<table bordercolor="blue" align="center" width="400" cellpadding="3" bgcolor="#ffffff">
	<tr> <td> <h2 style="color:blue"><center> LOGIN </center></h2></td> </tr>
	<tr> <td> <hr align="center" width="350" color="blue"/> </td></tr>
	
	<tr>
	<td style="font-family:Arial; color:blue" ><center>Username<center></td> </tr>
	<tr><td><center><input type="text" name="username" /></center></td>
	</tr><br />
	
	<tr>
	<td style="font-family:Arial; color:blue"><center>Password <center></td> </tr>
